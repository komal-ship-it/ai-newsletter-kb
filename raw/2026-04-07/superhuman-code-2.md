...
Welcome back. The number of strange things happening in AI is ridiculous. Yesterday, someone built an actual Indiana Jones-style whip for Claude Code (github repo: https://github.com/GitFrog1111/badclaude). And today, Milla Jovovich — yes, actress from the Resident Evil movies — announced that she has built an agentic memory tool that scored 100% on LongMemEval. Wild times.
...
Breakdown of how Claude Code constructs its system prompt: https://www.dbreunig.com/2026/04/04/how-claude-code-builds-a-system-prompt.html

---

## IN THE KNOW: What's trending on socials and headlines

- Faster RAG: How Perplexity, Azure, and HubSpot use a simple technique to make RAG 32x more memory efficient (explained with code) | https://x.com/_avichawla/status/2040326889928356122

- External Brain: Inspired by Andrej Karpathy, this thread walks you through building your own LLM knowledge base that compounds over time | https://x.com/hooeem/status/2041196025906418094

- Inside Codex: OpenAI's Head of DevRel and Codex product lead go behind the scenes on how the team actually ships products | https://www.youtube.com/watch?v=9qXc-THAvc0

- Agent Anatomy: When your AI agent fails, the problem is rarely the model. This deep dive shows how to turn a stateless LLM into a production agent | https://x.com/akshay_pachaar/status/2041146899319971922

- Leaked Playbook: Claude Code's source code was accidentally leaked, and here's a breakdown of how it constructs system prompts | https://www.dbreunig.com/2026/04/04/how-claude-code-builds-a-system-prompt.html

- Docs as Files: Most AI code fails when docs change. This tool turns live documentation into an accessible filesystem that agents can browse | https://x.com/arlanr/status/2041215978957389908

- Perfect Timing: OpenAI announced a new Safety Fellowship, hours after a New Yorker investigation revealed it had dissolved its safety teams | https://x.com/RonanFarrow/status/2041224604878864514

---

## AI CODING HACK: How to feed Claude Code skills real-time data

Claude Code skills are normally static, which usually means tedious manual copy-pasting for PR diffs or logs. Lydia Hallie, an engineer on the Claude Code team, recently shared a much better way: use the `!` backtick syntax to embed shell commands directly into your `SKILL.md`.
...
How to build your own AI agent from scratch: https://www.youtube.com/watch?v=pbAqx8B6NVc&t=876s
Learn how to build a custom AI meeting assistant with the Mastra TypeScript framework. Bridges core agent concepts like tools, memory, and event triggers by integrating Slack, Exa AI, and Cal.com into one seamless, automated workflow.

### Top Repo

Graphify: https://github.com/safishamsi/graphify
AI coding agent skill that turns any folder of code, docs, papers, or images into a queryable knowledge graph. Gives full system context so your agent can answer complex architecture questions with precision.

### Trending Paper

Cursor doubles AI coding speed on Blackwell GPUs (Warp Decode): https://cursor.com/blog/warp-decode
...
Source URL: https://codenewsletter.ai/p/openai-anthropic-google-fight-model-copying-meta-goes-open-source
