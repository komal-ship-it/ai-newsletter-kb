# TLDR AI — Raw — 2026-04-08

**Message ID:** 19d6cbaeea3ca580
**From:** dan@tldrnewsletter.com
**Subject:** Anthropic's superhuman hacker, Intel + Elon Terafab, S3 Files
...
Source: https://links.tldrnewsletter.com/gp8rGy (10 minute read)
...
Source: https://links.tldrnewsletter.com/rE1dKo (4 minute read)
...
Source: https://arstechnica.com/gadgets/2026/04/intel-is-going-all-in-on-advanced-chip-packaging/ (12 minute read)
...
Source: https://arstechnica.com/space/2026/04/astronauts-set-distance-record-revealing-the-moon-as-a-place-to-be-explored/ (18 minute read)
...
Source: https://www.allthingsdistributed.com/2026/04/s3-files-and-the-changing-face-of-s3.html (34 minute read)

### The Building Block Economy

The current most effective way to build software and get massive adoption is to create building blocks that enable and encourage others to build — quantity over quality, which ultimately leads to better mainline software. Agents readily pick open and free software over closed and commercial. Closed-source, commercial software is at a massive disadvantage.

Source: https://mitchellh.com/writing/building-block-economy (8 minute read)
...
- Google brings vertical tabs and improved reading mode to Chrome — Right-click any Chrome window and choose 'Show Tabs Vertically' | https://www.macrumors.com/2026/04/07/chrome-vertical-tabs/

- Impeccable — A set of AI skills that provides the design vocabulary required to create great design prompts | https://impeccable.style/

- Scion (GitHub repo) — Multi-agent orchestrator designed to manage deep agents in isolated containers so they can work on different parts of projects without stepping on each other | https://github.com/GoogleCloudPlatform/scion

- Apple's foldable iPhone remains on track for September debut — Production has yet to ramp up | https://links.tldrnewsletter.com/as9EHx

- Principles of Mechanical Sympathy — The practice of creating software that is sympathetic to its underlying hardware | https://martinfowler.com/articles/mechanical-sympathy-principles.html

- The Rivian R2 will launch with 335 miles of range (EPA certified) — 314 miles with 20-inch wheels | https://arstechnica.com/cars/2026/04/rivian-r2-epa-certification-leaked-gets-335-miles-of-range/
